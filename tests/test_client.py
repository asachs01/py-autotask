...
class TestAutotaskClient:
    ...
    def test_new_entity_access_patterns(self, mock_auth):
        ...
        new_entities = [
            'ActionTypes', 'AdditionalInvoiceFieldValues', 'APIUsageMetrics',
            'CompanyAlerts', 'CompanyNotes', 'TicketNotes', 'ConfigurationItemCategories',
            'ContractMilestones', 'SystemHealth', 'PerformanceMetrics'
        ]
    ...
    def test_entity_manager_contains_all_registered_entities(self, mock_auth):
        ...
        sample_entities = [
            'Tickets', 'Companies', 'Contacts', 'Projects', 'Resources',
            'ActionTypes', 'CompanyAlerts', 'TicketNotes', 'SystemHealth'
        ]
    ...
    @patch("requests.Session.post")
    def test_batch_operations_if_available(self, mock_post, mock_auth, sample_ticket_data):
