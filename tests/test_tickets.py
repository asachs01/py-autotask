...
class TestTicketsEntity:
    ...
    def test_get_tickets_by_account(self, tickets_entity, mock_client, sample_ticket_data):
    ...
    def test_get_tickets_by_account_with_status_filter(self, tickets_entity, mock_client):
