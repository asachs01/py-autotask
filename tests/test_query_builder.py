...
from py_autotask.entities.query_builder import QueryBuilder, FilterOperator, LogicalOperator
...
class TestQueryBuilder:
    ...
    def test_where_related(self, query_builder, mock_entity):
        ...
        with patch('py_autotask.entities.query_builder.QueryBuilder', return_value=mock_qb_chain):
            with patch.object(mock_entity, '_get_parent_field_name', return_value="companyID"):
                qb = query_builder.where_related("Companies", "companyName", "contains", "Acme")
