...
class TestIntegration:
    ...
    def test_entity_manager_initialization(self, client):
        ...
        entities = ['tickets', 'companies', 'contacts', 'projects', 
                   'resources', 'contracts', 'time_entries', 'attachments']
...
class TestIntegrationPerformance:
    ...
    def test_bulk_query_performance(self, client):
        ...
        try:
            ...
            print(f"Queried {len(companies.items)} companies in {query_time:.2f} seconds")
    ...
    def test_pagination_performance(self, client):
        ...
        try:
            ...
            assert avg_time_per_page < 5.0, f"Average page time: {avg_time_per_page:.2f}s"
            
            print(f"Processed {page_count} pages ({total_items} items) in {total_time:.2f} seconds")
