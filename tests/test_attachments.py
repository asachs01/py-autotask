...
class TestAttachmentsEntity:
    ...
    def test_upload_file_success(self, mock_guess_type, mock_path, attachments_entity, mock_client):
    ...
    def test_get_attachments_for_entity(self, attachments_entity, mock_client, sample_attachment_data):
    ...
    def test_get_attachment_info(self, attachments_entity, mock_client, sample_attachment_data):
    ...
    @patch('py_autotask.entities.attachments.mimetypes.guess_type')
    def test_content_type_detection(self, mock_guess_type, attachments_entity, mock_client):
