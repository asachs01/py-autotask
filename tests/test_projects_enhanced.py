...
class TestBudgetingAndCostTracking:
    ...
    def test_set_project_budget_missing_required_field(self, projects_entity):
        ...
        with pytest.raises(
            AutotaskValidationError, match="Missing required budget field"
        ):
    ...
    def test_get_budget_status(self, projects_entity, sample_project_data):
        ...
        projects_entity.get_by_id = Mock(return_value=sample_project_data)
        projects_entity.get_project_time_entries = Mock(
            return_value=[
    ...
    def test_calculate_project_profitability(
        self, projects_entity, sample_project_data
    ):
        """Test profitability calculation."""
        projects_entity.get_by_id = Mock(return_value=sample_project_data)
        projects_entity.get_budget_status = Mock(
            return_value={
                "budgets": {"total_budget": 100000},
                "actuals": {
                    "actual_labor_cost": 60000,
                    "actual_expenses": 12000,
                    "actual_materials": 8000,
                    "actual_hours": 750,
                },
...
class TestResourceAllocation:
    ...
    def test_allocate_resource_invalid_dates(self, projects_entity):
        ...
        with pytest.raises(
            AutotaskValidationError, match="End date must be after start date"
        ):
            projects_entity.allocate_resource(12345, 5001, allocation_data)

    def test_get_resource_allocation(
        self, projects_entity, sample_project_data, sample_tasks
    ):
        ...
        resource_5001 = next(
            r for r in result["resource_breakdown"] if r["resource_id"] == 5001
        )
    ...
    def test_optimize_resource_allocation(self, projects_entity, sample_project_data):
        ...
        projects_entity.get_by_id = Mock(return_value=sample_project_data)
        projects_entity.get_resource_allocation = Mock(
            return_value={
                "project_id": 12345,
                "resource_breakdown": [
                    {
...
class TestMilestoneAndPhaseManagement:
    ...
    def test_add_project_phase_missing_fields(self, projects_entity):
        ...
        with pytest.raises(
            AutotaskValidationError, match="Missing required phase field"
        ):
    ...
    def test_get_project_milestones(self, projects_entity, sample_project_data):
        ...
        projects_entity.get_by_id = Mock(return_value=sample_project_data)
        projects_entity.get_project_tasks = Mock(
            return_value=[
                {
                    "id": 1,
...
class TestProfitabilityAnalysis:
    ...
    def test_calculate_gross_margin(self, projects_entity):
        ...
        projects_entity.calculate_project_profitability = Mock(
            return_value={
                "financial_summary": {
                    "gross_margin": 25000,
    ...
    def test_get_profitability_report(self, projects_entity):
        ...
        projects_entity.get_budget_status = Mock(
            return_value={"budgets": {"total_budget": 100000}}
        )
        ...
        assert (
            result["performance_indicators"]["budget_variance"] == 20000
        )  # 100k - 80k
...
class TestProjectTemplates:
    ...
    def test_get_project_templates(self, projects_entity):
        ...
        web_template = next(
            t for t in templates if t["template_id"] == "web_development"
        )
    ...
    def test_save_as_template(self, projects_entity, sample_project_data, sample_tasks):
        ...
        result = projects_entity.save_as_template(
            12345, "Custom Template", "Template based on successful project"
        )
...
class TestGanttAndDependencies:
    ...
    def test_get_gantt_data(self, projects_entity, sample_project_data, sample_tasks):
        ...
        assert (
            result["timeline_metadata"]["completed_tasks"] == 1
        )  # One task 100% complete
...
class TestValidationAndHelpers:
    ...
    def test_get_project_health_score(self, projects_entity, sample_project_data):
        ...
        projects_entity.get_by_id = Mock(return_value=sample_project_data)
        projects_entity.get_budget_status = Mock(
            return_value={"utilization": {"total_budget": 85}}
        )
        projects_entity.get_resource_allocation = Mock(
            return_value={
...
class TestHelperMethods:
    ...
    def test_has_circular_dependency(self, projects_entity):
        ...
        projects_entity.client.query = Mock(
            return_value=[{"predecessors": "1"}]  # Task 2 depends on task 1
        )
