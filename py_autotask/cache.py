    ...
    def delete(self, key: str) -> bool:
        ...
        for backend in self.backends:
            try:
                ...
                logger.debug(f"Cache backend {type(backend).__name__} delete failed: {e}")
    ...
    def exists(self, key: str) -> bool:
        ...
        for backend in self.backends:
            try:
                ...
                logger.debug(f"Cache backend {type(backend).__name__} exists check failed: {e}")
    ...
    def clear(self) -> bool:
        ...
        for backend in self.backends:
            try:
                ...
                logger.error(f"Failed to clear cache backend {type(backend).__name__}: {e}")
    ...
    def invalidate_pattern(self, pattern: str) -> int:
        ...
        for backend in self.backends:
            try:
                ...
                logger.debug(f"Pattern invalidation failed for {type(backend).__name__}: {e}")
