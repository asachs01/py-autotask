...
class TimeEntryData(BaseModel):
    ...
    resource_id: Optional[int] = Field(None, description="ID of resource who logged time")
    ...
    date_worked: Optional[str] = Field(None, description="Date work was performed (YYYY-MM-DD)")
    ...
    hours_to_bill: Optional[float] = Field(None, description="Hours to bill to customer")
    
    # Billing and invoicing fields
    billable_to_account: Optional[bool] = Field(None, description="Whether entry is billable")
    non_billable: Optional[bool] = Field(None, description="Whether entry is non-billable")
    ...
    type: Optional[int] = Field(None, description="Time entry type (1=Regular, 2=Overtime, etc.)")
    status: Optional[int] = Field(None, description="Entry status (1=Draft, 2=Submitted, etc.)")
    
    # Approval workflow fields
    submitted_date: Optional[str] = Field(None, description="Date/time submitted for approval")
    ...
    internal_notes: Optional[str] = Field(None, description="Internal notes (not customer-visible)")
    summary_notes: Optional[str] = Field(None, description="Summary notes (may be customer-visible)")
    
    # Overtime and special handling
    is_overtime: Optional[bool] = Field(None, description="Whether entry qualifies as overtime")
    is_holiday: Optional[bool] = Field(None, description="Whether work was on holiday")
    overtime_multiplier: Optional[float] = Field(None, description="Overtime rate multiplier")
    ...
    week_ending_date: Optional[str] = Field(None, description="Week ending date for time sheet")
    ...
    last_modified_by: Optional[int] = Field(None, description="Resource ID who last modified entry")
    
    # Analytics and reporting fields
    utilization_percentage: Optional[float] = Field(None, description="Resource utilization %")
    efficiency_rating: Optional[float] = Field(None, description="Work efficiency rating")
    
    # Additional metadata
    work_location: Optional[str] = Field(None, description="Location where work was performed")
