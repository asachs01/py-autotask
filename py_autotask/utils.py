...
def build_query_params(query: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        params = query_request.model_dump(
            exclude_none=True, 
            by_alias=True
        )
...
def log_api_call(method: str, url: str, params: Optional[Dict[str, Any]] = None,
                data: Optional[Dict[str, Any]] = None, response_time: Optional[float] = None) -> None:
    """
...
def validate_filter(filter_dict: Dict[str, Any]) -> None:
    ...
    # Validate operation
    valid_ops = ['eq', 'ne', 'gt', 'gte', 'lt', 'lte', 'beginsWith', 
                'endsWith', 'contains', 'isNull', 'isNotNull', 'in', 'notIn']
    ...
    ops_requiring_value = ['eq', 'ne', 'gt', 'gte', 'lt', 'lte', 
                          'beginsWith', 'endsWith', 'contains', 'in', 'notIn']
