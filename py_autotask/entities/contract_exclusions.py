...
class ContractExclusionsEntity(BaseEntity):
    ...
    def update(self, contract_exclusion_id: int, update_data: Dict[str, Any]) -> UpdateResponse:
        """
    ...
    def get_by_type(self, exclusion_type: str, contract_id: Optional[int] = None) -> List[Dict[str, Any]]:
        """
    ...
    def get_resource_exclusions(self, contract_id: int, resource_id: Optional[int] = None) -> List[Dict[str, Any]]:
        """
    ...
    def get_service_exclusions(self, contract_id: int, service_id: Optional[int] = None) -> List[Dict[str, Any]]:
        """
    ...
    def get_active_exclusions(self, contract_id: int, as_of_date: Optional[date] = None) -> List[Dict[str, Any]]:
        """
    ...
    def check_exclusion(self, contract_id: int, exclusion_type: str, 
                       resource_id: Optional[int] = None, service_id: Optional[int] = None,
                       check_date: Optional[date] = None) -> Dict[str, Any]:
        """
        ...
        if is_excluded and matching_exclusions:
            ...
            reason = matching_exclusions[0].get('reason') or matching_exclusions[0].get('description')
    ...
    def bulk_create_exclusions(self, contract_id: int, exclusions_data: List[Dict[str, Any]]) -> List[CreateResponse]:
        """
    ...
    def validate_exclusion_data(self, exclusion_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if exclusion_type == 'Resource' and exclusion_data.get('serviceID'):
            warnings.append("Service ID specified for resource exclusion (will be ignored)")
        elif exclusion_type == 'Service' and exclusion_data.get('resourceID'):
            warnings.append("Resource ID specified for service exclusion (will be ignored)")
