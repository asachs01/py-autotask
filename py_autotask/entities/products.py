...
class ProductsEntity(BaseEntity):
    ...
    def bulk_update_pricing(
        ...
        for update in pricing_updates:
            ...
            try:
                result = self.update_product_pricing(product_id, unit_price, unit_cost, effective_date)
    ...
    def get_product_catalog_report(
        ...
        return {
            "catalog_summary": {
                ...
                "average_product_price": total_value / len(products) if products else Decimal("0")
            },
    ...
    def clone_product(
        ...
        clone_data = {k: v for k, v in source_product.items() 
