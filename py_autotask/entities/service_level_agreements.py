...
class ServiceLevelAgreementsEntity(BaseEntity):
    ...
    def bulk_update_sla_terms(
        ...
        for update in sla_updates:
            ...
            try:
                result = self.update_sla_terms(sla_id, response_time, resolution_time, effective_date)
    ...
    def clone_sla(
        ...
        clone_data = {k: v for k, v in source_sla.items() 
