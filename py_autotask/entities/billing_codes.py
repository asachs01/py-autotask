...
class BillingCodesEntity(BaseEntity):
    ...
    def calculate_rate_markup(
        self,
        billing_code_id: int,
        markup_percentage: Union[float, Decimal]
    ) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            "effective_markup": float((current_price - current_cost) / current_cost * 100) if current_cost > 0 else 0
        }
    ...
    def bulk_update_rates(
        ...
        for update in rate_updates:
            ...
            try:
                ...
                results.append({"id": billing_code_id, "success": True, "result": result})
            except Exception as e:
                results.append({"id": billing_code_id, "success": False, "error": str(e)})
    ...
    def get_billing_codes_with_rates(
        ...
        for code in billing_codes:
            ...
            code["markup_percentage"] = float((unit_price - unit_cost) / unit_cost * 100) if unit_cost > 0 else 0
    ...
    def copy_billing_code(
        ...
        copy_data = {k: v for k, v in source_code.items() 
