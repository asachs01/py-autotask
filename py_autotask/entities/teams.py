...
class TeamsEntity(BaseEntity):
    ...
    def get_teams_by_lead(
        self,
        lead_resource_id: int
    ) -> List[Dict[str, Any]]:
        """
    ...
    def update_team_lead(
        ...
        return self.update(team_id, {
            "teamLeadResourceID": new_lead_resource_id
        })
    ...
    def bulk_assign_members(
        ...
        for assignment in team_assignments:
            ...
            try:
                ...
                results.append({"team_id": team_id, "resource_id": resource_id, "success": True, "result": result})
            except Exception as e:
                results.append({"team_id": team_id, "resource_id": resource_id, "success": False, "error": str(e)})
    ...
    def clone_team(
        ...
        clone_data = {k: v for k, v in source_team.items() 
