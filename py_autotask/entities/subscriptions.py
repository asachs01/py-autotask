...
class SubscriptionsEntity(BaseEntity):
    ...
    def get_expiring_subscriptions(
        ...
        return self.query(filter=f"endDate le {cutoff_date.isoformat()} and status eq 'Active'")
    ...
    def cancel_subscription(
        ...
        update_data = {
            "status": "Cancelled",
            "endDate": cancellation_date.isoformat()
        }
    ...
    def get_subscription_analytics(
        ...
        return {
            ...
            "summary": {
                ...
                "average_subscription_value": total_revenue / len(subscriptions) if subscriptions else Decimal("0")
            }
        }
    
    def bulk_renew_subscriptions(
        self,
        subscription_renewals: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
        ...
        for renewal in subscription_renewals:
            ...
            try:
                ...
                results.append({"id": subscription_id, "success": True, "result": result})
            except Exception as e:
                results.append({"id": subscription_id, "success": False, "error": str(e)})
