...
class ConfigurationItemTypesEntity(BaseEntity):
    ...
    def clone_ci_type(
        ...
        clone_data = {k: v for k, v in source_ci_type.items() 
    ...
    def get_ci_types_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "by_warranty": {warranty: len(types) for warranty, types in warranty_groups.items()},
    ...
    def bulk_update_warranty_periods(
        self,
        warranty_updates: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
