...
class TicketCategoriesEntity(BaseEntity):
    ...
    def get_active_categories(self, include_inactive: bool = False) -> List[Dict[str, Any]]:
        """
    ...
    def get_category_hierarchy(self, parent_id: Optional[int] = None) -> List[Dict[str, Any]]:
        """
    ...
    def get_subcategories(self, category_id: int, recursive: bool = False) -> List[Dict[str, Any]]:
        """
    ...
    def create_category_hierarchy(self, hierarchy_data: Dict[str, Any]) -> List[CreateResponse]:
        """
        ...
        def create_category_recursive(category_data: Dict[str, Any], parent_id: Optional[int] = None):
    ...
    def move_category(self, category_id: int, new_parent_id: Optional[int]) -> UpdateResponse:
        """
    ...
    def set_category_order(self, category_orders: List[Dict[str, Any]]) -> List[UpdateResponse]:
        """
    ...
    def get_category_usage_stats(self, category_id: int, date_range: Optional[tuple] = None) -> Dict[str, Any]:
        """
