...
class ResourceRolesEntity(BaseEntity):
    ...
    def copy_role(
        ...
        copy_data = {k: v for k, v in source_role.items() 
    ...
    def get_role_hierarchy(self) -> Dict[str, Any]:
        ...
        sorted_roles = sorted(roles, 
                            key=lambda x: x.get("hourlyRate", 0), 
                            reverse=True)
        ...
        return {
            ...
            "hierarchy_levels": {
                ...
                "senior": [r for r in sorted_roles if 100 <= r.get("hourlyRate", 0) < 200],
    ...
    def get_role_cost_analysis(
        ...
        return {
            ...
            "summary": {
                ...
                "average_rate": sum(Decimal(str(r.get("hourlyRate", 0))) for r in roles) / len(roles) if roles else Decimal("0")
            },
